  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Post New Stock </li>
      </ol>
    </section>
   <!-- Main content -->
           ...
           <div class="col-xs-12">
            ...
            <div class="box">
                    <div class="box-header with-border">
                      <h3 class="box-title">Post New Stock Picks</h3>
                    </div>
                    <!-- /.box-header -->
                  <form role="form" action="{{ url('admin/create_stock') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                              ...
                              <div class="box-body">
                                <div class="col-sm-12 row" id="">
                                      ...
                                      <div class="form-group  col-sm-6">
                                          ...
                                          <input type="text" name="stock_name" class="form-control" placeholder="Enter Stock Name" data-validation="required">
                                          
                                          @if($errors->has('stock_name'))
                                          <span class="has-errors text-red">{{ $errors->first('stock_name') }}</span>
                                          @endif
                                      </div>
                                      <div class="form-group col-sm-12 holdfor_block d-none">
                                      ...
                                      <div class="form-group col-sm-6">
                                          ...
                                          <input type="text" name="current_market_price" class="form-control" placeholder="Enter Current Market Price" data-validation="required">
                                      ...
                                      <div class="form-group col-sm-6">
                                          ...
                                          <input type="text" name="target_price" class="form-control" placeholder="Enter Target Price" data-validation="required">
                                      ...
                                      <div class="form-group col-sm-12">
                                          ...
                                          <input type="text" name="listed_in" class="form-control" placeholder="Enter listed in" data-validation="required">
                                      ...
                                      <div class="form-group col-sm-12">
                                          ...
                                          <textarea name="description" class="form-control" placeholder="Enter Description" data-validation="required"></textarea>
                                      ...
                                      <div class="form-group col-sm-12">
                                         <label for="reason">Reason</label> 
                                          <textarea name="reason" class="form-control" placeholder="Enter Reason" data-validation="required"></textarea>
